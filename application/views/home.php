   ...
   <body class="skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../layout/top-nav.html"><i class="fa fa-circle-o"></i> Consulta</a></li>
                <li><a href="../layout/boxed.html"><i class="fa fa-circle-o"></i> Cadastro</a></li>
              </ul>
            </li>
            <li>
              <a href="../widgets.html">
                <i class="fa fa-th"></i> <span>Professor</span> <small class="label pull-right bg-green">new</small>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class="active"><a href="#revenue-chart" data-toggle="tab">Tarefas</a></li>
                  <li><a href="#sales-chart" data-toggle="tab">Prova</a></li>
                  <li class="pull-left header"><i class="fa fa-inbox"></i> Aprovação</li>
                </ul>
      ...
      <footer class="main-footer">
        ...
        <p>Pagina renderizada em <strong>{elapsed_time}</strong> segundos. <?php echo  (ENVIRONMENT === 'development') ?  'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?></p>
      </footer>
