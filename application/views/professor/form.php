            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">     
                  ...
                  <?php echo form_open('professor/insert'); ?>
                  ...
                  <div class="row">
                     ...
                     <div class="col-xs-1" style="margin-left:11%">
                        <div class="input-group">
                          <span class="input-group-addon">UF: </span>  
                          <input type="text" id="uf" name="uf" class="form-control" data-inputmask="'mask': 'AA'" data-mask value="" style="width:50px">
                      </div>
                    </div>
                    ...
                    <h3><strong>Disciplina:</strong></h3>
                        ...
                        <div class="col-md-5 form-group has-warning">
                            ...
                            <select name="disciplina" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" >
                                ...
                                <?php foreach($disciplina as $value): ?>
                                    <option value="<?php echo $value->iddisciplina; ?>"><?php echo $value->descricao; ?></option>
                                <?php endforeach; ?>
                          </select>
                        </div><!-- / Coluna 4 input -->
                    </div>
