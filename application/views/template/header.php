...
<html>
  <head>
    ...
    <!--  iCheck ALL -->
    <link href="<?php echo base_url('public/plugins/iCheck/all.css')?>"rel="stylesheet" type="text/css"  />
    <!-- Morris chart -->
    ...
    <link href="<?php echo base_url('public/dist/css/Questao.css')?>"rel="stylesheet" type="text/css"  />
