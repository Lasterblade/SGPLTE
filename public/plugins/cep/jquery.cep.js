...
(function ($) {
    ...
    $.fn.cep = function (options) {
        ...
        var settings = {
            ...
            ajax: {
                url: "https://sgplte-lasterblade1.c9.io/aluno/buscar_endereco",
    ...
    $(document).ready(function () {
        $("[role=\"cep\"]").each(function () {
            ...
            var settings = {
                ...
                ajax: {
                    url: self.attr("cep-ajax-url") != null ? self.attr("cep-ajax-url") : "https://sgplte-lasterblade1.c9.io/aluno/buscar_endereco",
